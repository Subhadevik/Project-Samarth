...
from utils import DataHandler, QueryEngine, PANDAS_AVAILABLE

if PANDAS_AVAILABLE:
    logger.info("Full features loaded successfully with pandas")
    FULL_FEATURES = True
else:
    logger.info("Using simplified features for deployment (no pandas)")
    FULL_FEATURES = False
